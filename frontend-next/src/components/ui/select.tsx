  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        variant === "glass" &&
          "glass-bg border-white/20 text-white [&_svg]:text-white/70 dark:bg-transparent dark:hover:bg-white/5",
        variant === "default" && "bg-transparent dark:bg-input/30 dark:hover:bg-input/50",
        className
      )}
      {...props}
    >
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          variant === "glass" &&
            "glass-bg border-white/20 text-white [&_[data-slot=select-item]]:focus:bg-white/10 [&_[data-slot=select-item]]:focus:text-white",
