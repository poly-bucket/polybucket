        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              {/* Model Color */}
              <div className="mb-3">
                <label className="block text-sm text-gray-300 mb-1">Model Color</label>
                <input
                  type="color"
              ...
              {/* Metalness */}
              <div className="mb-3">
                <label className="block text-sm text-gray-300 mb-1">Metalness: {renderSettings.metalness}</label>
                <input
                  type="range"
                  min="0"
                  max="1"
              ...
              {/* Roughness */}
              <div className="mb-3">
                <label className="block text-sm text-gray-300 mb-1">Roughness: {renderSettings.roughness}</label>
                <input
                  type="range"
                  min="0"
                  max="1"
              ...
              {/* View Mode */}
              <div className="mb-3">
                <label className="block text-sm text-gray-300 mb-1">View Mode</label>
                <select
              ...
              {/* Camera Distance */}
              <div className="mb-3">
                <label className="block text-sm text-gray-300 mb-1">Camera Distance: {renderSettings.cameraDistance}</label>
                <input
                  type="range"
                  min="1"
                  max="5"
              ...
              {/* Light Intensity */}
              <div className="mb-3">
                <label className="block text-sm text-gray-300 mb-1">Light Intensity: {renderSettings.lightIntensity}</label>
                <input
                  type="range"
                  min="0"
                  max="2"
            ...
            {webglError && (
              <div className="mb-3 p-3 bg-red-900 border border-red-600 rounded text-red-200 text-sm">
                ...
                <button
                  ...
                  className="mt-2 w-full px-3 py-1 bg-red-700 hover:bg-red-600 rounded text-sm"
                >
                  Refresh Canvas
                </button>
              </div>
