...
namespace PolyBucket.Api.Features.Users.Queries
{
    ...
    [Route("api/users")]
    [Authorize]
    public class GetUserByIdQueryController : ControllerBase
    {
        private readonly GetUserByIdQueryHandler _getUserByIdQueryHandler;
        private readonly ILogger<GetUserByIdQueryController> _logger;

        public GetUserByIdQueryController(GetUserByIdQueryHandler getUserByIdQueryHandler, ILogger<GetUserByIdQueryController> logger)
        {
