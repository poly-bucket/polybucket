...
namespace PolyBucket.Api.Features.Users.Queries
{
    ...
    [Authorize]
    public class GetUserSettingsQueryController : ControllerBase
    {
        private readonly GetUserSettingsQueryHandler _handler;
        private readonly ILogger<GetUserSettingsQueryController> _logger;

        public GetUserSettingsQueryController(GetUserSettingsQueryHandler handler, ILogger<GetUserSettingsQueryController> logger)
        {
            _handler = handler;
            _logger = logger;
        }
