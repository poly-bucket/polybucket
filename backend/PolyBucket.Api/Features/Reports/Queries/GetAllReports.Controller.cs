...
namespace PolyBucket.Api.Features.Reports.Queries
{
    ...
    public class GetAllReportsController(IReportingPlugin reportingPlugin) : ControllerBase
    {
            ...
            [FromQuery] ReportType? type = null)
        {
            ...
            var reports = await _reportingPlugin.GetAllReportsAsync(page, pageSize, isResolved, type);
            return Ok(reports);
        }
    }
} 