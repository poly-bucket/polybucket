...
namespace PolyBucket.Api.Features.SystemSettings.GetModelConfigurationSettings.Domain
{
    public class GetModelConfigurationSettingsQueryHandler(
        PolyBucketDbContext context,
        ILogger<GetModelConfigurationSettingsQueryHandler> logger) : IRequestHandler<GetModelConfigurationSettingsQuery, GetModelConfigurationSettingsResponse>
    {
        private readonly PolyBucketDbContext _context = context;
        private readonly ILogger<GetModelConfigurationSettingsQueryHandler> _logger = logger;

        public async Task<GetModelConfigurationSettingsResponse> Handle(GetModelConfigurationSettingsQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    return new GetModelConfigurationSettingsResponse
                    {
                        Success = false,
                ...
                var settings = new ModelConfigurationSettingsData
                {
