...
{
    public class GetModelConfigurationSettingsQuery : IRequest<GetModelConfigurationSettingsResponse>
    {
    }

    public class GetModelConfigurationSettingsResponse
    {
        public bool Success { get; set; }
        public string Message { get; set; } = string.Empty;
        public ModelConfigurationSettingsData? Settings { get; set; }
    }

    public class ModelConfigurationSettingsData
    {
