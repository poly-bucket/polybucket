...
namespace PolyBucket.Api.Features.SystemSettings.UpdateModelConfigurationSettings.Domain
{
    public class UpdateModelConfigurationSettingsCommandHandler(
        PolyBucketDbContext context,
        ILogger<UpdateModelConfigurationSettingsCommandHandler> logger,
        IHttpContextAccessor httpContextAccessor) : IRequestHandler<UpdateModelConfigurationSettingsCommand, UpdateModelConfigurationSettingsResponse>
    {
        private readonly PolyBucketDbContext _context = context;
        private readonly ILogger<UpdateModelConfigurationSettingsCommandHandler> _logger = logger;
        private readonly IHttpContextAccessor _httpContextAccessor = httpContextAccessor;

        public async Task<UpdateModelConfigurationSettingsResponse> Handle(UpdateModelConfigurationSettingsCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    return new UpdateModelConfigurationSettingsResponse
                    {
                        Success = false,
