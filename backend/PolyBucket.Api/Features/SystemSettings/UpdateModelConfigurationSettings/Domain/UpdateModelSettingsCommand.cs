...
{
    public class UpdateModelConfigurationSettingsCommand : IRequest<UpdateModelConfigurationSettingsResponse>
    {
    ...
    public class UpdateModelConfigurationSettingsResponse
    {
