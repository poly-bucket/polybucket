...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            Infrastructure.InfrastructureServiceRegistration.AddInfrastructureServices(builder.Services, builder.Configuration);
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                try
                {
                    var db = services.GetRequiredService<Infrastructure.Data.DatabaseContext>();
